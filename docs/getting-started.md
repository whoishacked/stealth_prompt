...
The Chrome Web Store build updates automatically. To test unreleased extension code:
...
select `extension/dist`. After another build, press **Reload** on that extension card.
